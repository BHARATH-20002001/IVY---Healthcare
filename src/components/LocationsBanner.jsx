...
import AmenitiesBannerImg from "../assets/location-banner-img.png"; // Placeholder
  ...
  return (
    <section className="relative w-full h-[350px] md:h-[450px] overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${AmenitiesBannerImg})`,
        }}
      />
      ...
      */}
      ...
      {/* Content Container */}
      <div className="relative z-10 h-full w-full max-w-[1240px] mx-auto px-[20px] lg:px-0 flex flex-col justify-center items-start">
