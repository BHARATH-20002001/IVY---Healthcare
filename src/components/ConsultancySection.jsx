    ...
    <section className="py-16 md:py-24 bg-white dark:bg-[#0F0F0F] transition-colors duration-300">
      <div className="max-w-[1240px] mx-auto px-6 lg:px-0">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-16">
          ...
          <div className="w-full lg:w-[calc(55%-2rem)] grid grid-cols-2 gap-[10px] h-[300px] sm:h-[400px] md:h-[650px] mt-10 lg:mt-0 order-2 lg:order-1">
            {/* Left Image Column */}
            <div className="flex flex-col h-full justify-end pt-6 sm:pt-10 md:pt-24">
              {/* Teal Line */}
              <div className="w-[calc(100%+10px)] h-2 bg-[#25758A] mb-4 md:mb-5 rounded-l-sm"></div>
              {/* Image */}
              <img
                src="src/assets/conselt-img1.png"
            ...
            {/* Right Image Column */}
            <div className="h-full pb-6 sm:pb-10 md:pb-24">
              <img
                src="src/assets/conselt-img2.png"
          ...
          <div className="w-full lg:w-[calc(45%-2rem)] flex flex-col items-start order-1 lg:order-2">
            <span className="font-jost text-[#247c8f] dark:text-[#56b9cb] text-sm md:text-base tracking-[0.2em] uppercase font-semibold mb-4">
              Just A Consultancy
            </span>

            <h2 className="font-redhat text-3xl md:text-4xl lg:text-[35px] text-stone-900 dark:text-white leading-[1.1] mb-6">
